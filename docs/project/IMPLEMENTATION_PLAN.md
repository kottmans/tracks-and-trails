...
> needed. The episode is preserved in `docs/project/REVIEWS.md` and in `OPS-004`/`T-026`: the amendment
...
>
**Exited 2026-07-29.** The Phase 1 exit review is recorded in `docs/project/REVIEWS.md`.
...
`docs/project/TESTING.md` §10 is canonical for what runs when. No test was deleted or skipped; `T-123` is
...
happened on 2026-08-03 and Phase 2 did not exit** (`docs/project/REVIEWS.md`, submitted head `5eb2611`).
...
- **Real sites are unverified**; every fixture is recorded or derived (`docs/project/TESTING.md` §5).
...
already been corrected. The unexecuted state is history and is kept in `docs/project/REVIEWS.md`; it is no
...
**Decomposed 2026-08-09**, on maintainer direction, into `docs/project/TASKS.md` §`## Proposed — Phase 4`.
...
- *(Added 2026-08-09 by maintainer ruling)* **The built window matches the flow that was agreed** —
  evidenced by a **recorded checklist run against the running application**, in `docs/project/evidence/`, the
...
- **Nothing is left in the `unruled` class.** Met for the audit's original fifteen (`SEC-004`,
  2026-08-16) and still binding: a phase that exits with an unclassified option has an
  unenforceable refusal list
...
- **The Windows manual verification session is complete** and recorded in `REVIEWS.md`
  (`docs/project/TESTING.md` §8 item 15). `OPS-004` shrank this to the subjective residue — whether the
