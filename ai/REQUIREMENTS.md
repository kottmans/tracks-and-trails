...
- **REQ-015** — Per job, support cancel, pause, resume, retry, and remove. Cancelling must terminate the underlying work promptly and must not leave the UI unresponsive.
