...
#: The fields a preset is recognised by: every one it owns. Naming used to be excluded here, and
#: since `UX-014` a preset carries none to exclude.
IDENTIFYING_FIELDS: Final[frozenset[str]] = PRESET_OWNED_FIELDS
